...
class Window extends JFrame implements ActionListener, ChangeListener {
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        if (s == toolSizeSlider) {
            // TODO: #01. Implement me!
	        	JSlider toolSlider = (JSlider) s;
	        	if (toolSlider.getValue() <= sliderMax && 
	        			toolSlider.getValue() >= sliderMin) {
	        		canvas.setToolSize(toolSlider.getValue());
    ...
    private void updateSizeLabel() {
        ...
        // A field of class Window gives you a pointer to the Canvas object.
    		sizeLabel.setText("Image: " + canvas.getImg().getWidth() + "x" + canvas.getImg().getHeight());
    ...
    private static ImageIcon getIcon(Color c, int size) {
        // TODO: #03. Implement me!
	    	...
	    	Graphics2D icon2d= (Graphics2D) icon.getGraphics();
	    	icon2d.setColor(c);
	    	icon2d.fillRect(0, 0, size, size);
